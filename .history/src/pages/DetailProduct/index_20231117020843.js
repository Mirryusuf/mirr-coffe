    ...
    <>
      ...
      >
        ...
        >
          ...
          <View>
            <View style={{width: 75, backgroundColor: "pink", flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
              <TouchableOpacity style={{padding: 10, backgroundColor: "cyan"}}>

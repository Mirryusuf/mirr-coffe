...
export default function DetailProduct({ navigation, route }) {
  ...
  return (
    <>
      ...
      <View
        style={{ height: 75, width: "100%", backgroundColor: "pink", paddingHorizontal: 20, justifyContent: "center", alignItems: "center" }}
      >
        <View
          style={{
            flexDirection: "row",
        ...
        >
          <View
            style={{ height: 55, width: "30%", backgroundColor: "#C67C4E" }}
          >
            <Text>test</Text>
          </View>

          <View
            style={{ height: 55, width: "55%", backgroundColor: "#C67C4E" }}
          >
            <Text>test</Text>
          </View>
        </View>

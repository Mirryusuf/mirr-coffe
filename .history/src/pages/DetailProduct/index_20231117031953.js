              ...
              {coffeeSize.map((type, index) => (
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    borderRadius: 12,
                    backgroundColor:
                      index === activeIndexSize ? "#C67C4E" : "#F2F2F2",
                    justifyContent: "center",
                    alignItems: "center",
                  }}
                ...
                >
                  <Text
                    style={{
                      fontSize: 14,
                      color: index === activeIndexSize ? "#F2F2F2" : "#C67C4E",
                      fontWeight: "600",
                    }}
                  >
                    {type}
              ...
              {coffeeTemperature.map((type, index) => (
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    borderRadius: 12,
                    backgroundColor:
                      index === activeIndexTemperature ? "#C67C4E" : "#F2F2F2",
                    justifyContent: "center",
                    alignItems: "center",
                    marginRight: "6%",
                  }}
                ...
                >
                  <Text
                    style={{
                      fontSize: 14,
                      color:
                        index === activeIndexTemperature ? "#F2F2F2" : "#C67C4E",
                      fontWeight: "600",
                    }}
                  >
                    {type}

        ...
        {activeOrderMethod === 0 ? (
          <View>
            <View style={{ marginTop: 20 }}>
              ...
              <View>
                <Image source={require("../../../assets/maps.jpg")} style={{height: 55, width: 55, borderRadius: 13}} resizeMode="cover" />
              </View>
            </View>
        ...
        <View>
          ...
          <View>
            ...
            >
              ...
              <Text style={{ fontSize: 14, color: "#2F2D2C" }}>Rp.{numberWithCommas(ongkir)}</Text>
            </View>
            ...
            >
              ...
              <Text style={{ fontSize: 14, color: "#2F2D2C" }}>Rp.{numberWithCommas(totalPriceAll + ongkir)}</Text>
            </View>
          </View>
        </View>

    ...
    <>
      ...
      >
        <Ionicons
          ...
          style={{ marginRight: 2 }}
        />
        <Text style={{position: "absolute", top: -5, backgroundColor: "white", height: 22, width: 22, justifyContent: "center", alignItems: "center," borderRadius: 50, color: "#C67C4E"}}>1</Text>
      </TouchableOpacity>
    </>
  );
}

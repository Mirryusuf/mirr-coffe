      ...
      <View style={{ flex: 1, marginTop: 30 }}>
        ...
        >
          <View style={{flexDirection: "row", height: 44}}>
            <View style={{backgroundColor: "pink", width: "70%", justifyContent: "center", alignItems: "flex-start"}}>
              <Text>Location</Text>
              <Text>Jl. Ciragil, Kebayoran Baru</Text>
            </View>
            <View style={{backgroundColor: "cyan", width: "30%", justifyContent: "center", alignItems: "flex-end"}}>
